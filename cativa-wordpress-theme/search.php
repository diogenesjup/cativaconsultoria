...
<section class="titulo">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1>
                 Resultado de pesquisa: <?php echo $query_string; ?>
                </h1>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-12 categorias">
                ...
                <a href="<?php echo get_option('home'); ?>/" class="categoria" title="TODOS">
                    TODOS
                </a>
                ...
                ?>
	                ...
	                <a href="<?php echo $link_home; ?>/categorias/<?php echo $cat->slug; ?>"  class="categoria <?php if(get_permalink()==$link_home."/categorias/".$cat->slug) echo "categoria-ativa"; ?>" title="<?php echo $cat->name; ?>">
	                    <?php echo $cat->name; ?>
	                </a>
                ...
                <div class="form-group">
                    <select class="form-control" id="categoriasMobile" onchange="location.href=$(this).val();">
                       ...
                       <option <?php if(get_permalink()==$link_home."/categorias/".$cat->slug) echo "selected"; ?> value="<?php echo $link_home; ?>/categorias/<?php echo $cat->slug; ?>"><?php echo $cat->name; ?></option>
                       <?php 
        ...
        <div class="row loop">            
            ...
            <?php                 
                            ...
                            $search = new WP_Query(array( 's' => $query_string, 'paged' => $paged )); 
