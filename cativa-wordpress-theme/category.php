        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-12 categorias">
                ...
                ?>
	                ...
	                <a href="<?php echo $link_home; ?>/categorias/<?php echo $cat->slug; ?>"  class="categoria <?php if($term->slug==$cat->slug) echo "categoria-ativa"; ?>" title="<?php echo $cat->name; ?>">
	                    <?php echo $cat->name; ?>	                   
	                </a>
                ...
                <div class="form-group">
                    <select class="form-control" id="categoriasMobile" onchange="location.href=$(this).val();">
                       ...
                       <option <?php if($term->slug==$cat->slug) echo "selected"; ?> value="<?php echo $link_home; ?>/categorias/<?php echo $cat->slug; ?>"><?php echo $cat->name; ?></option>
                       <?php 
