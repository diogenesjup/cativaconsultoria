    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-9 logo">
                <a href="<?php echo get_option('home'); ?>/" title="Cativa - Tudo sobre finanças">
                    <img src="<?php bloginfo('stylesheet_directory'); ?>/images/logo.svg" alt="Cativa - Tudo sobre finanças">
                </a>
            </div>
            <!-- LOGO -->
            <!-- MENU DESKTOP -->
            <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-12 menu-desktop">
            	 <?php $itens_menu = wp_get_menu_array("principal"); ?> 
                 <nav>
                    <ul>
                               <?php 
                                     foreach($itens_menu as $menu){
                                       $classe = "";
                                       if(get_the_permalink()==$menu["url"]) $classe = "ativo";
                                           if(count($menu["children"])==0):
                                ?>
                                            <li class="<?php echo $classe; ?>"><a href="<?php echo $menu["url"]; ?>" title="<?php echo $menu["title"]; ?>"><?php echo $menu["title"]; ?></a></li>
                                <?php
            ...
            <div class="col-3 menu-mobile">
                <a href="javascript:void(0)" title="Menu mobile" onclick="abrirFecharMenuMobile()">
